...
class BufferGeometryUtils {
  ...
  static mergeBufferGeometries(
    ...
    const morphAttributes: Record<
      string,
      Array<Array<THREE.BufferAttribute | THREE.InterleavedBufferAttribute>>
    > = {};
  ...
  static mergeBufferAttributes(
    attributes: Array<BufferAttribute | InterleavedBufferAttribute>
  ) {
    let TypedArray;
    let itemSize;
    let normalized;
  ...
  static computeMorphedAttributes(
    ...
    const morphedNormalAttribute = new Float32BufferAttribute(
      modifiedNormal,
      3
    );
