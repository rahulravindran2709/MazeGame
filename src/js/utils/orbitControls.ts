    ...
    constructor(object: THREE.Camera, domElement: HTMLElement) {
        ...
        return function pan(deltaX: number, deltaY: number) {
          ...
          if ((scope.object as THREE.PerspectiveCamera).isPerspectiveCamera) {
            ...
            targetDistance *= Math.tan(
              (((scope.object as THREE.PerspectiveCamera).fov / 2) * Math.PI) /
                180.0
            ...
            panLeft(
              (deltaX *
                ((scope.object as THREE.OrthographicCamera).right -
                  (scope.object as THREE.OrthographicCamera).left)) /
                (scope.object as THREE.OrthographicCamera).zoom /
                element.clientWidth,
              scope.object.matrix
            );
            panUp(
              (deltaY *
                ((scope.object as THREE.OrthographicCamera).top -
                  (scope.object as THREE.OrthographicCamera).bottom)) /
                (scope.object as THREE.OrthographicCamera).zoom /
      ...
      function dollyOut(dollyScale: number) {
        if ((scope.object as THREE.PerspectiveCamera).isPerspectiveCamera) {
          ...
          (scope.object as THREE.OrthographicCamera).zoom = Math.max(
            scope.minZoom,
            Math.min(
              scope.maxZoom,
              (scope.object as THREE.OrthographicCamera).zoom * dollyScale
            )
          );
